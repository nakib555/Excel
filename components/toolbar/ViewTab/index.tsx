        ...
        <RibbonGroup label="Show">
             <div className="flex gap-4 px-2 h-full items-center">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <label className="flex items-center gap-1 text-[10px] text-slate-600"><input type="checkbox" checked /> Gridlines</label>
                    <label className="flex items-center gap-1 text-[10px] text-slate-600"><input type="checkbox" checked /> Formula Bar</label>
                </div>
                 <div className="flex flex-col gap-1">
                    <label className="flex items-center gap-1 text-[10px] text-slate-600"><input type="checkbox" checked /> Headings</label>
                    <label className="flex items-center gap-1 text-[10px] text-slate-600"><input type="checkbox" checked /> Data Type Icons</label>
